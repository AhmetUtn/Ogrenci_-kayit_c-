...
namespace _21300031063_Ahmet_Utan {
    ...
    public partial class dbLoginDataSet : global::System.Data.DataSet {
        ...
        public partial class tblUserDataTable : global::System.Data.TypedTableBase<tblUserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tblUserRow AddtblUserRow(string usr, string pwd) {
        ...
        public partial class tblUserRow : global::System.Data.DataRow {
            ...
            public string usr {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'tblUser\' tablosundaki \'usr\' sütunun değeri DBNull.", e);
                    }
                }
                set {
            ...
            public string pwd {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'tblUser\' tablosundaki \'pwd\' sütunun değeri DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsusrNull() {
                return this.IsNull(this.tabletblUser.usrColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetusrNull() {
                this[this.tabletblUser.usrColumn] = global::System.Convert.DBNull;
            }
...
namespace _21300031063_Ahmet_Utan.dbLoginDataSetTableAdapters {
    ...
    public partial class tblUserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblUser] WHERE (([id] = @Original_id) AND ((@IsNull_usr = 1 AN" +
                "D [usr] IS NULL) OR ([usr] = @Original_usr)) AND ((@IsNull_pwd = 1 AND [pwd] IS " +
                "NULL) OR ([pwd] = @Original_pwd)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblUser] ([usr], [pwd]) VALUES (@usr, @pwd);\r\nSELECT id, usr, " +
                "pwd FROM tblUser WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblUser] SET [usr] = @usr, [pwd] = @pwd WHERE (([id] = @Original_id) AND ((@IsNull_usr = 1 AND [usr] IS NULL) OR ([usr] = @Original_usr)) AND ((@IsNull_pwd = 1 AND [pwd] IS NULL) OR ([pwd] = @Original_pwd)));
SELECT id, usr, pwd FROM tblUser WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_21300031063_Ahmet_Utan.Properties.Settings.Default.dbLoginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, usr, pwd FROM dbo.tblUser";
        ...
        public virtual int Fill(dbLoginDataSet.tblUserDataTable dataTable) {
        ...
        public virtual dbLoginDataSet.tblUserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbLoginDataSet.tblUserDataTable dataTable = new dbLoginDataSet.tblUserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbLoginDataSet.tblUserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_usr, string Original_pwd) {
            ...
            if ((Original_usr == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_usr));
            }
        ...
        public virtual int Update(string usr, string pwd, int Original_id, string Original_usr, string Original_pwd, int id) {
            if ((usr == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string usr, string pwd, int Original_id, string Original_usr, string Original_pwd) {
            return this.Update(usr, pwd, Original_id, Original_usr, Original_pwd, Original_id);
        }
    }
